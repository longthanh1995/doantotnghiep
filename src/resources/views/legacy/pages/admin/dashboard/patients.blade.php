...
@section('pageTitle', 'Manage Patients')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form action="{{route('admin.patient')}}" class="form" id="form_search_patients">
                        <div class="form-group col-md-4 col-md-offset-3">
                            <input type="text" class="form-control" id="form_search_patients__input_query" name="query" value="" placeholder="Input Name/National ID Number/Combination here..."/>
                        </div>
                    ...
                    <table class="table table-hover" id="table_patients">
                        ...
                        @foreach($patients as $patient)
                            <tr data-id="{{$patient->id}}" data-name="{{$patient->getFullname()}}">
                                ...
                                <td>
                                    <a target="_blank" href="{{ route('admin.patient.details', $patient->id) }}" class="btn btn-xs btn-default" data-action="info">
...
//        $('#table_patients').DataTable();
    ...
    {% if patients.length > 0 %}
        ...
        <tr data-id="@{{patient.id}}">
            ...
            <td>
                <a target="_blank" href="@{{patientDetailsUrlBase}}/@{{ patient.id }}" class="btn btn-xs btn-default" data-action="info">
                    <i class="fa fa-info"></i> Info
                </a>
                <!--<a href="#" class="btn btn-xs btn-danger" data-action="remove">
                    <i class="fa fa-times"></i> Remove
    ...
    $(function(){
        $('#form_search_patients')
            .on('submit', function(event){
                ...
                var request = $.ajax({
                    url: laroute.route('admin.patient.search'),
                    method: "POST",
                    data: {
                    ...
                    .done(function(response) {
                        ...
                        var html = swig.render(tableBodyTemplate, {
                            locals: {
                                ...
                                patientDetailsUrlBase: '/back-office/patients'
                            }
                        });
