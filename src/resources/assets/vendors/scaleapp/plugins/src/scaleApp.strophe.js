...
(function() {
  ...
  saveData = function(conn, opt) {
    ...
    ref1 = ["host", "port", "path", "protocol"];
    results = [];
    for (l = 0, len1 = ref1.length; l < len1; l++) {
      k = ref1[l];
      if (opt[k] != null) {
        results.push(sessionStorage[key2cache(k)] = opt[k]);
      }
    }
    return results;
  };
  ...
  clearData = function() {
    ...
    ref = ["jid", "sid", "rid", "host", "port", "path", "protocol"];
    results = [];
    for (i = 0, len = ref.length; i < len; i++) {
      k = ref[i];
      results.push(sessionStorage.removeItem(key2cache(k)));
    }
    return results;
  };

  restoreData = function() {
    var i, j, k, len, o, ref, results;
    if (typeof sessionStorage === "undefined" || sessionStorage === null) {
      return;
    }
    o = {};
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      j = key2cache(k);
      if (sessionStorage[j]) {
        results.push(o[k] = sessionStorage[j]);
      } else {
        results.push(void 0);
      }
    }
  ...
  plugin = function(core) {
    ...
    onConnected = function() {
      var e, fn, i, l, len, len1, onunload, ref, ref1;
      fn = function(ev) {
        if (ev.keyCode === 27) {
      ...
      if (document.addEventListener != null) {
        ...
        ref1 = ["onkeydown", "onkeypress", "onkeyup"];
        for (l = 0, len1 = ref1.length; l < len1; l++) {
          e = ref1[l];
