...
/**
 * Class MarkAppointmentAsLate
 * @package App\Jobs\Appointment
 */
class MarkAppointmentAsLate extends Job
{
    /**
    ...
    public function handle(AppointmentRepositoryInterface $appointmentRepository)
    {
        $appointmentRepository->update($this->appointment, [
            'appointment_status_id' => AppointmentStatus::STATUS_LATE,
        ]);
        ...
        dispatch(new CreateActivity(
            ...
            'appointment',
            $this->appointment->id,
            'Doctor '.$this->doctor->name.' marked appointment #'.$this->appointment->id. ' as late'
        ));
    }
}
